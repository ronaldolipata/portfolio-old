      ...
      <div className={style.subContainer}>
        <div className={style.aboutTextContainer}>
          <p className={style.text}>
            ...
            graduated with a Bachelor's degree in IT. Aside from Web
            Development, I am also a Blockchain enthusiast.
          </p>
          <p className={style.text}>
            Having a passion in Web Development makes me feel elated every time
